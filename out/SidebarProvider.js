...
const newView_1 = require("./views/newView");
const searchView_1 = require("./views/searchView");
const currentView_1 = require("./views/currentView");
        ...
        <body>
            ...
            <div class="wireframe-split-frame">
                ...
                <div class="right-display-board">
                    ...
                    ${(0, searchView_1.getSearchView)()}
                    ${(0, newView_1.getNewView)()}
                    ${(0, currentView_1.getCurrentView)()}
                    ${(0, settingsView_1.getSettingsView)()}
